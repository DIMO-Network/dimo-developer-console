...
const cspHeader = `
    ...
    object-src 'none';
    base-uri 'self';
    connect-src 'self' http://*.dimo.org https://*.dimo.org https://api.stripe.com https://api.turnkey.com https://explorer-api.walletconnect.com https://*.sentry.io https://polygon-mainnet.g.alchemy.com https://polygon-amoy.g.alchemy.com https://pulse.walletconnect.org https://rpc.zerodev.app https://*.vercel.app https://vercel.live;
    font-src 'self';
