...
const documents: Documents = {
    ...
    "\n  query AllVehicles($first: Int, $last: Int, $before: String, $after: String) {\n    vehicles(first: $first, last: $last, before:$before, after:$after) {\n      totalCount\n      pageInfo {\n        startCursor\n        endCursor\n        hasNextPage\n        hasPreviousPage\n      }\n      nodes {\n        tokenId\n        definition {\n          make\n          model\n          year\n        }\n      }  \n    }\n  }\n": types.AllVehiclesDocument,
    "\n  fragment DeveloperLicenseVehicleDetailsNodesFragment on VehicleConnection {\n    totalCount\n    nodes {\n      tokenId\n      definition {\n        make\n        model\n        year\n      }\n    }\n  }\n": types.DeveloperLicenseVehicleDetailsNodesFragmentFragmentDoc,
