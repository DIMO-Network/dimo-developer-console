...
export type DeveloperLicenseSummaryFragmentFragment = { __typename?: 'DeveloperLicense', alias?: string | null, tokenId: number, clientId: any, owner: any, mintedAt: any } & { ' $fragmentName'?: 'DeveloperLicenseSummaryFragmentFragment' };
