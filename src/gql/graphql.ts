...
export type DeveloperLicenseDetailsPageSummaryQueryVariables = Exact<{
  tokenId: Scalars['Int']['input'];
}>;


export type DeveloperLicenseDetailsPageSummaryQuery = { __typename?: 'Query', developerLicense: { __typename?: 'DeveloperLicense', tokenId: number, alias?: string | null } };
...
export const DeveloperLicenseDetailsPageSummaryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DeveloperLicenseDetailsPageSummary"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tokenId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"developerLicense"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"tokenId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tokenId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tokenId"}},{"kind":"Field","name":{"kind":"Name","value":"alias"}}]}}]}}]} as unknown as DocumentNode<DeveloperLicenseDetailsPageSummaryQuery, DeveloperLicenseDetailsPageSummaryQueryVariables>;