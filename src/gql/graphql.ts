...
export type TotalDeveloperLicenseCountFragmentFragment = {
  __typename?: 'DeveloperLicenseConnection';
  totalCount: number;
} & { ' $fragmentName'?: 'TotalDeveloperLicenseCountFragmentFragment' };
...
export type GetDeveloperLicensesByOwnerQuery = {
  __typename?: 'Query';
  developerLicenses: { __typename?: 'DeveloperLicenseConnection' } & {
    ' $fragmentRefs'?: {
      TotalDeveloperLicenseCountFragmentFragment: TotalDeveloperLicenseCountFragmentFragment;
      DeveloperLicenseSummariesOnConnectionFragment: DeveloperLicenseSummariesOnConnectionFragment;
    };
  };
};
...
export type SignerFragmentFragment = {
  ...
  signers: {
    __typename?: 'SignerConnection';
    nodes: Array<{ __typename?: 'Signer'; address: any; enabledAt: any }>;
  };
} & { ' $fragmentName'?: 'SignerFragmentFragment' };

export type DeveloperLicenseVehiclesFragmentFragment = {
  __typename?: 'DeveloperLicense';
  clientId: any;
} & { ' $fragmentName'?: 'DeveloperLicenseVehiclesFragmentFragment' };

export type GetVehicleCountByClientIdQueryVariables = Exact<{
  clientId: Scalars['Address']['input'];
}>;

export type GetVehicleCountByClientIdQuery = {
  __typename?: 'Query';
  vehicles: { __typename?: 'VehicleConnection'; totalCount: number };
};
...
export type GetDeveloperLicenseQuery = {
  ...
  developerLicense: { __typename?: 'DeveloperLicense' } & {
    ' $fragmentRefs'?: {
      ...
      DeveloperLicenseVehiclesFragmentFragment: DeveloperLicenseVehiclesFragmentFragment;
    };
  };
};

export type DeveloperLicenseSummariesOnConnectionFragment = {
  __typename?: 'DeveloperLicenseConnection';
  nodes: Array<
    { __typename?: 'DeveloperLicense' } & {
      ' $fragmentRefs'?: {
...
export const TotalDeveloperLicenseCountFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TotalDeveloperLicenseCountFragment' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'DeveloperLicenseConnection' },
      },
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<TotalDeveloperLicenseCountFragmentFragment, unknown>;
...
export const DeveloperLicenseVehiclesFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      ...
      selectionSet: {
        kind: 'SelectionSet',
        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'clientId' } }],
      },
    },
  ],
} as unknown as DocumentNode<DeveloperLicenseVehiclesFragmentFragment, unknown>;
...
export const DeveloperLicenseSummariesOnConnectionFragmentDoc = {
  ...
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'DeveloperLicenseSummariesOnConnection' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'DeveloperLicenseConnection' },
      },
...
} as unknown as DocumentNode<DeveloperLicenseSummariesOnConnectionFragment, unknown>;
...
>;
export const GetVehicleCountByClientIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetVehicleCountByClientId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
              ...
              },
              {
                ...
                value: {
                  ...
                  fields: [
                    {
                      kind: 'ObjectField',
                      name: { kind: 'Name', value: 'privileged' },
                      value: {
                        kind: 'Variable',
  ...
  GetVehicleCountByClientIdQuery,
  GetVehicleCountByClientIdQueryVariables
>;
