...
export type RedirectUriFragmentFragment = { __typename?: 'DeveloperLicense', redirectURIs: { __typename?: 'RedirectURIConnection', nodes: Array<{ __typename?: 'RedirectURI', uri: string }> } } & { ' $fragmentName'?: 'RedirectUriFragmentFragment' };
