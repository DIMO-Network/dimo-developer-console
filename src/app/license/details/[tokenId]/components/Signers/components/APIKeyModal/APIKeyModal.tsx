...
export const APIKeyModal: FC<Props> = ({ isOpen, apiKey, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} showClose={false} setIsOpen={() => null} className={'signer-generated-modal'}>
      <div className={'flex flex-col gap-12 flex-1'}>
        <Title component={'h2'} className={'text-2xl !leading-8'}>API key generated</Title>
        <div className={'bg-feedback-success bg-opacity-50 py-3 px-4 rounded-xl flex flex-col gap-2'}>
          <p className={'text-sm'}>Make sure to copy your API key now as you will not be able to see this again.</p>
...
const CopyableApiKey = ({ value, text }: {value: string; text: string;}) => {
  ...
  return (
    <div className={"flex flex-row gap-2.5 bg-surface-raised py-2 px-3 rounded-xl items-center max-w-full"}>
