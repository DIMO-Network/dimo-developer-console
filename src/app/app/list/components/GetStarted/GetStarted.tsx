...
export const GetStarted: FC<IProps> = ({ hasBalance, hasApps }) => {
  ...
  const renderAction = ({
  ...
  }: { Icon: ReactElement<any, string>, title: string, description: string, actionLabel: string, actionCta: () => void, completed: boolean }) => {
    return <div className="action">
      ...
      <div className="action-cta">
        <Button className="dark rounded-sm w-full" onClick={actionCta} type="button">
  ...
  return <div className="get-started-content">
    <Title component="h4" className="title">How to get started</Title>
    <div className="actions-content">
      {renderAction({
        Icon: <CubeIcon className="h-5 w-5" />,
        title: 'Purchase DCX',
        description: 'Obtain DCX to get credits, unlocking the DIMO developer ecosystem',
