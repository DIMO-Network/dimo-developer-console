...
export const View: FC = () => {
    ...
    // Scenario 1: No DCX balance, no apps, and onboarding is not completed
    if (!hasDCXBalance && !hasApps && !isOnboardingCompleted) {
        return (
            <div className="home-page">
                <div className="welcome-message">
                    ...
                    <div className="onboarding-section">
                        ...
                        <p>
                            DCX is a stablecoin that's pegged to one-tenth of a cent (0.001
                            USD), and is essential for all developers building on DIMO.
                            For DIMO protocol fees, spending DCX or $DIMO is required.
                        </p>
                    </div>
                ...
                <div className="welcome-message">
                    ...
                    <div className="attention-box">
                        <p className="attention-text">
                            ...
                            developer account needs DCX to function properly. Please purchase
